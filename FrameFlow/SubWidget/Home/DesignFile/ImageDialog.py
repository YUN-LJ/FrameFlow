...
from qfluentwidgets.components.widgets import (BodyLabel, PrimaryPushButton, ProgressBar, SmoothScrollArea)
...
class Ui_Image(object):
    def setupUi(self, Image):
        ...
        self.scrollArea = SmoothScrollArea(Image)
        ...
        self.label_local_path_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_purity_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_category_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_file_size_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_id_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_local_path = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_remote_path_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_category = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_data_value = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_file_size = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_id = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_remote_path = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_data = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_purity = BodyLabel(self.scrollAreaWidgetContents)
        ...
        self.label_tags = BodyLabel(self.scrollAreaWidgetContents)
