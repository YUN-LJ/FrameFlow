...
class Ui_image_display(object):
    def setupUi(self, image_display):
        ...
        self.scrollArea = SmoothScrollArea(image_display)
        ...
        self.retranslateUi(image_display)
    ...
    def retranslateUi(self, image_display):
        ...
        self.groupBox_image.setTitle(QCoreApplication.translate("image_display", u"\u56fe\u50cf\u9884\u89c8:", None))
        self.checkBox.setText(QCoreApplication.translate("image_display", u"\u81ea\u52a8\u6682\u505c", None))
        ...
        self.groupBox_info.setTitle(QCoreApplication.translate("image_display", u"\u56fe\u50cf\u4fe1\u606f", None))
        ...
        self.label_local_path.setText(QCoreApplication.translate("image_display", u"\u672c\u5730\u8def\u5f84\uff1a", None))
        self.label_remote_path_value.setText("")
        self.label_category.setText(QCoreApplication.translate("image_display", u"\u5206\u7c7b\uff1a", None))
        self.label_data_value.setText("")
        self.label_file_size.setText(QCoreApplication.translate("image_display", u"\u6587\u4ef6\u5927\u5c0f:", None))
        self.label_id.setText(QCoreApplication.translate("image_display", u"\u56fe\u50cfID\uff1a", None))
        self.label_remote_path.setText(QCoreApplication.translate("image_display", u"\u8fdc\u7a0b\u8def\u5f84\uff1a", None))
        self.label_data.setText(QCoreApplication.translate("image_display", u"\u65e5\u671f\uff1a", None))
        self.label_purity.setText(QCoreApplication.translate("image_display", u"\u5206\u7ea7\uff1a", None))
        self.label_tags.setText(QCoreApplication.translate("image_display", u"\u6807\u7b7e\u4fe1\u606f:", None))
    # retranslateUi
