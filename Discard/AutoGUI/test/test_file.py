...
def check_locked():
    if is_screen_locked():
        ...
        print("电脑未锁屏")
        # 调试信息
        print(f"锁屏进程存在: {is_lock_screen_present()}")
        print(f"桌面可访问: {is_desktop_accessible()}")
